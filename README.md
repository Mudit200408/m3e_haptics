...
> Starting with `v1.0.0`, `m3e_haptics` is migrated to use the standalone `material_ui` package decoupled in **Flutter 3.47.0**.
...
> - If you are on Flutter `< 3.47.0`, please use `m3e_haptics: ^0.0.1`.

Add `m3e_haptics` and `material_ui` to your `pubspec.yaml`:
